...
def limpiar_datos(dataframes, year=2022, origin=None, destiny=None):
    # Validar que el año sea realista y se encuentre en un rango aceptable
    if year > 2023:
        year = 2022 # Usamos 2022, ya que los dos primeros datasets pertenecen a ese año
    ...
    for df_name, df in dataframes_copiados.items():
        ...
        if "Periodo" in df.columns:
            ...
            dataframes_copiados[df_name] = df_year
